    ...
    try {
      ...
      const data = await db
        .select({
          ...
          assignedAddressId: settlementApplications.assignedAddressId,
    ...
    try {
      ...
      const result = await db
        ...
        .values({
          ...
          legalPersonName: data.legalPersonName || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('legal_person'))?.name) || null,
          legalPersonPhone: data.legalPersonPhone || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('legal_person'))?.phone) || null,
          legalPersonEmail: data.legalPersonEmail || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('legal_person'))?.email) || null,
          legalPersonAddress: data.legalPersonAddress || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('legal_person'))?.address) || null,
          shareholders: data.shareholders || [],
          personnel: data.personnel || [],
          supervisorName: data.supervisorName || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('supervisor'))?.name) || null,
          supervisorPhone: data.supervisorPhone || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('supervisor'))?.phone) || null,
          financeManagerName: data.financeManagerName || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('finance_manager'))?.name) || null,
          financeManagerPhone: data.financeManagerPhone || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('finance_manager'))?.phone) || null,
          contactPersonName: data.contactPersonName || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('ewt_contact'))?.name) || null,
          contactPersonPhone: data.contactPersonPhone || (data.personnel && data.personnel.find((p: any) => p.roles?.includes('ewt_contact'))?.phone) || null,
