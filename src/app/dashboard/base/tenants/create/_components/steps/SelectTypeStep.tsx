        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-step-violet-muted flex items-center justify-center">
                <Home className="w-8 h-8 text-step-violet" />
              </div>
          ...
          >
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-step-amber-muted flex items-center justify-center">
                <Store className="w-8 h-8 text-step-amber" />
              </div>
